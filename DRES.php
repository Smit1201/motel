...
<html>
    ...
    <body>
        ...
        if (!empty($_GET)) {
            ...
            if ($status == 1) {
                $sql = "UPDATE reg_res SET status=0 WHERE rid='$rid'";
                $r = mysqli_query($conn, $sql);
            }
            header("Location:DRES.php");
        }
        ?>
...
// Check connection
                                        ...
                                        $sql = "SELECT * FROM reg_res WHERE status=1";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while ($row = mysqli_fetch_row($result)) {
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <br> <br><a href='DRES.php?rid=<?php echo $row[0]; ?>&status=1' class="btn btn-info">Disable</a>
                                                </div>
                                                <?php
                                            }
                                        } else {
