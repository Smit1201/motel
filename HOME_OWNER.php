...
<html lang="en">
    <head>
        <title>Super-8 Motel | Home_OWNER</title>
        <!-- custom-theme -->
                                ...
                                <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                                    <nav class="link-effect-12">
                                        <ul class="nav navbar-nav w3_agile_nav">
                                            <li class="active">
                                                <a href="HOME_OWNER.php"><span>Home</span></a></li>
                                            <li><a href="gallery_OWNER.php"><span>Gallery</span></a></li>
                                            <li><a href="REGISTRATION_Manager.php"><span>Enroll Manager</span></a></li>
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu agile_short_dropdown">
                                                    ...
                                                    <li><a href="typography.php">Offers</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu agile_short_dropdown">
                                                    ...
                                                    <li><a href="offers.php">Manager Details</a></li>
                                           ...
                                           <li><a href="about_OWNER.php"><span>About Us</span></a></li>
            ...
            <div class="container">
                <div class="footer-grids">
                    ...
                    <div class="col-md-3 footer-grid">
                        ...
                        <div class="footer-grid-info">
                            <ul>
                                <li><a href="HOME_OWNER.php">Home</a></li>
                                <li><a href="about_OWNER.php">About</a></li>
                                <li><a href="gallery_OWNER.php">Gallery</a></li>
                               </ul>
                        </div>
                    </div>
                    <div class="clearfix"> </div>
