...
<html lang="en">
    <head>
        <title><?php  ?>Super-8 Motel | Home_MANAGER</title>
        <!-- custom-theme -->
    ...
    <body>
        <div class="spinner-wrapper">
            <div class="spinner"><img src="images/LOGO.jpg" alt=""/></div>
                                        ...
                                        <ul class="nav navbar-nav w3_agile_nav">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu agile_short_dropdown">
                                                    <li><a href="Taxes_M.php">Taxes</a></li>
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu agile_short_dropdown">
                                                    <li><a href="viewoffer_M.php">Offers</a></li>  
                                                    <li><a href="Guest_details.php">Guest Details</a></li>
                                                    <li><a href="Staff_Details.php">Staff Details</a></li>
                                                    <li><a href="Receptionist_Details.php">Receptionist Details</a></li>
                                                    <li><a href="Book_Room_details.php">Booked Room Details</a></li>
                                                    <li><a href="cancle_room_details.php"> Canceled Room Details </a></li>
                                                </ul>
                                            </li>
                    ...
                    <div class="col-md-4 agileits-w3layouts-grid">
                        ...
                        <div class="wthree_agile_us">
                            ...
                            <div class="col-xs-9 agile-why-text two">
                                ...
                                <p>You can pay at the time of chack-</p>
                            </div>
                            <div class="clearfix"> </div>
                        </div>
                        <div class="clearfix"> </div>
