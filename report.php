...
//                        $d1 = "select sum(price) from tbl_order_detail, tbl_order where tbl_order_detail.oid = tbl_order.oid and tbl_order.date = '$date'";
                                            ...
                                            echo '<table border="5"><tr><td>Name</td><td>EmailID</td><td>PhoneNo.</td><td>Country</td><td>Check-In</td><td>Check-Out</td><td>RoomNumber</td></tr><tr>';
