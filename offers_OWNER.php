...
<html lang="en">
    <head>
        <title>SUPER 8 Motel|Offers_OWNER</title>
        <!-- custom-theme -->
                ...
                <div class="header">
                    <div class="container">
                        <div class="w3_agile_logo">
                            <h1><a href="index.php"><span>SUPER</span>EIGHT</a></h1>
                        </div>
                                        ...
                                        <ul class="nav navbar-nav w3_agile_nav">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu agile_short_dropdown">
                                                    ...
                                                    <li><a href="offers_OWNER.php">Offers</a></li>
                                                </ul>
                                            </li>
                                            <li class="dropdown">
            ...
            <div class="main-w3layouts-form">
                ...
                <form action="#" method="post">
                    <div class="fields-w3-agileits">
                        ...
                        <input type="text" name="offername" required="" placeholder="Offer Name" />
                    </div>
                    <div class="fields-w3-agileits">
                        <span class="fa fa-dollar" aria-hidden="true"></span>
                        <select id="discount" style="width: 400px; background-color: rgba(0, 0, 0, 0.45); color: white; font-family: Montserrat;font-size:14px">
                            <option>10%</option>
                            <option>20%</option>
                            <option>30%</option>
                            <option>40%</option>
